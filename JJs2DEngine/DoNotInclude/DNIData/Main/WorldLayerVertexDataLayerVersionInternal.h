...
namespace JJs2DEngine
{
	...
	struct WorldLayerObjectDataInternal;
	typedef std::optional<WorldLayerObjectDataInternal> WorldLayerObjectDataOptional;
	...
	{
	public:
		WorldLayerVertexDataLayerVersionInternal(TextureDataMainInternal& textureDataList, VS::DataBufferLists& dataBufferList, size_t maxObjectAmount, size_t layersDepth,
	...
	private:
		...
		std::vector<WorldLayerObjectDataOptional> _objectList;
